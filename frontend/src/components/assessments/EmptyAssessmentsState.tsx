...
/** Figma Lab-empty (2107:105338) — document illustration for empty assessments. */
const EmptyAssessmentsState = ({
  title = "No assessments assigned yet",
  description = "Assign assessments will appear here",
  className,
}: EmptyAssessmentsStateProps) => {
  return (
    <div
      className={cn(
...
export default EmptyAssessmentsState;

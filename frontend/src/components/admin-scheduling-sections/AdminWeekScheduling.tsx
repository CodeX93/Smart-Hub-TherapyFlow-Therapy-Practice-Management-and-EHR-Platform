...
import WeeklyTimeline from "../scheduling-sections/weekly-timeline";
import {
...
const AdminWeekScheduling = ({
  ...
  const sessionsQueryArgs = useMemo(
    ...
    // weekStart/weekEnd are derived each render; key on calendar day.
...
export default AdminWeekScheduling;

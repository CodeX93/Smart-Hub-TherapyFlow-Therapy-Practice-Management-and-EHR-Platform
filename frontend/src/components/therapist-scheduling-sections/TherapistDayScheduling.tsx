...
const TherapistDayScheduling = ({
  ...
  const calendarQueryArgs = useMemo(
    ...
    [appliedSearchQuery, filters, monthEnd, monthStart, scheduleTimezone],
  );
  ...
  const sessionsQueryArgs = useMemo(
    () =>
      buildSessionsQueryArgs({
        pageSize: CALENDAR_SESSIONS_PAGE_SIZE,
        rangeStart: selectedFullDate,
        rangeEnd: selectedFullDate,
        filters,
        searchQuery: appliedSearchQuery,
        mySessionsOnly: false,
        timezone: scheduleTimezone,
      }),
    [appliedSearchQuery, filters, scheduleTimezone, selectedFullDate],
  );
  ...
  const { data: overviewStats } = useGetSessionOverviewStatsQuery(
    buildOverviewStatsArgs(selectedFullDate, selectedFullDate, filters, scheduleTimezone),
  );
...
export default TherapistDayScheduling;
